...
<div class="container">
    <ul class="nav nav-tabs mb-4">
        ...
        <li class="nav-item"><a class="nav-link tooltip-test" data-bs-toggle="tab" href="#agenda" title="Agenda Ormawa"><b>Agenda Ormawa</b></a></li>
    </ul>
    ...
    <div class="tab-content">
        ...
        <div class="tab-pane fade show active" id="dashboard">
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-xl-4 col-md-6 mb-4 mt-3">
                        <div class="card border-danger shadow h-100 py-2">
                            <div class="card-body">
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        <div class="text-xs font-weight-bold text-danger text-uppercase mb-1">Total inventaris bem fki ums</div>
                            ...
                            <div class="card-body">
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        ...
                                        <div class="h5 mb-0 font-weight-bold text-gray-800"><?= $most_b_n->nama_aset; ?></div>
                                    </div>
                                    <div class="col-auto">
                    ...
                    <div class="col-xl-4 col-md-6 mb-4 mt-3">
                        <div class="card border-warning shadow h-100 py-2">
                            <div class="card-body">
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">admin ormawa fki</div>
                                        <div class="h5 mb-0 font-weight-bold text-gray-800"><?= $total_admin; ?></div>
                                    </div>
                                    <div class="col-auto">
                                        <i class="fas fa-people-group fa-2x text-gray-300" style="color:gold; opacity:60%;"></i>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <!-- jumlah agenda ormawa fki -->
                    <div class="col-xl-4 col-md-6 mb-4 mt-3">
                        <div class="card border-secondary shadow h-100 py-2">
                            <div class="card-body">
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        <div class="text-xs font-weight-bold text-secondary text-uppercase mb-1">agenda ormawa fki</div>
                                        <div class="h5 mb-0 font-weight-bold text-gray-800"><?= $total_agenda; ?></div>
                                    </div>
                                    <div class="col-auto">
                                        <i class="fas fa-calendar-days fa-2x" style="color:darkgray; opacity:60%;"></i>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="tab-pane fade" id="ajuan">
            ...
            <div class="row">
                <div class="col">
                    <h3>Daftar ajuan peminjaman aset ke BEM FKI UMS</h3>
        ...
        <!-- Menampilkan semua data inventaris bem fki -->
            ...
            <div class="row mt-4">
                <div class="col">
                    ...
                    <div style="float: right;">
                        <button type="button" class="bi bi-filter btn btn-success my-3" data-bs-toggle="modal" data-bs-target="#rentang_i">
                            Filter
                        </button>
                        <a align="right" class="bi bi-printer btn btn-primary no-print" data-bs-toggle="modal" data-bs-target="#laporan_i"> Cetak</a>
                    </div>
                    <div class="table-responsive">
        ...
        <div class="tab-pane fade" id="agenda">
            ...
            <div class="row mt-4">
                <div class="col">
                    <h3>Agenda Ormawa Fakultas Komunikasi & Informatika</h3>
                    <?php if (session()->getFlashData('Success_m')) : ?>
                        <div class="alert alert-success d-flex align-items-center bi bi-check-lg" role="alert">
                            <div>
                                <?= session()->getFlashdata('Success_m'); ?>
                            </div>
                        </div>
                    <?php endif; ?>
                    <?php if (session()->getFlashdata('Fail_m')) : ?>
                        <div class="alert alert-danger d-flex align-items-center bi bi-x-lg" role="alert">
                            <div>
                                <?= session()->getFlashdata('Fail_m'); ?>
                            </div>
                        </div>
                    <?php endif; ?>
                    <button type="button" class="bi bi-plus-square btn btn-primary my-3" data-bs-toggle="modal" data-bs-target="#add">
                        Tambah data
                    </button>
                    <div style="float: right;">
                        <button type="button" class="bi bi-filter btn btn-success my-3" data-bs-toggle="modal" data-bs-target="#rentang_a">
                            Filter
                        </button>
                        <a align="right" class="bi bi-printer btn btn-primary no-print" data-bs-toggle="modal" data-bs-target="#laporan_a"> Cetak</a>
                    </div>
                    <div class="table-responsive">
                            ...
                            <tbody>
                                ...
                                <?php foreach ($home as $h) : ?>
                                    <tr>
                                        ...
                                        <td><?= $h['tempat']; ?></td>
                                        <td>
                                            <button type="button" class="bi bi-pencil-square btn btn-warning tooltip-test" title="Edit data" data-bs-toggle="modal" data-bs-target="#ubah<?= $h['id_agenda']; ?>">

                                            </button>
                                            <button type="button" class="bi bi-trash btn btn-danger tooltip-test" title="Hapus data" data-bs-toggle="modal" data-bs-target="#delete<?= $h['id_agenda']; ?>">
...
<!-- script for set value 1 or 0 on switch type input -->
<script type="text/javascript">
    $('#cb_nb').on('change', function() {
...
<!-- modal untuk tambah daftar agenda -->
<div class="modal fade" id="add" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Tambah data agenda baru</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form novalidate action="/admin/adm_bem/tambah" role="form" method="POST" enctype="multipart/form-data" id="form_tambah" class="needs-validation">
                <?= csrf_field(); ?>
                <input type="hidden" name="<?= csrf_token() ?>" value="<?= csrf_hash() ?>" />
                <div class="modal-body">
                    <div class="row">
                        <div class="mb-3 col-md-12 form-group">
                            <label for="agenda" class="form-label"><b>Nama agenda</b></label>
                            <input type="text" class="form-control <?= (\Config\Services::validation()->hasError('agenda')) ? 'is-invalid' : ''; ?>" id="agenda" name="agenda" value="<?= old('agenda'); ?>">
                            <div class="invalid-feedback">
                                <?= \Config\Services::validation()->getError('agenda'); ?>
                            </div>
                        </div>
                        <div class="mb-3 col-md-12 form-group">
                            <label for="penyelenggara" class="form-label"><b>Penyelenggara agenda</b></label>
                            <input type="text" class="form-control <?= (\Config\Services::validation()->hasError('penyelenggara')) ? 'is-invalid' : ''; ?>" id="penyelenggara" name="penyelenggara" value="<?= old('penyelenggara'); ?>">
                            <div class="invalid-feedback">
                                <?= \Config\Services::validation()->getError('penyelenggara'); ?>
                            </div>
                        </div>
                        <div class="mb-3 col-md-6 form-group">
                            <label for="waktu" class="form-label"><b>Tanggal</b></label>
                            <input type="date" id="picker_agenda" class="form-control <?= (\Config\Services::validation()->hasError('waktu')) ? 'is-invalid' : ''; ?>" id="waktu" name="waktu" value="<?= old('waktu'); ?>">
                            <div class="invalid-feedback">
                                <?= \Config\Services::validation()->getError('waktu'); ?>
                            </div>
                        </div>
                        <div class="mb-3 col-md-6 form-group">
                            <label for="jam" class="form-label"><b>Pukul</b></label>
                            <input type="time" id="picker_agenda" class="form-control <?= (\Config\Services::validation()->hasError('jam')) ? 'is-invalid' : ''; ?>" id="jam" name="jam" value="<?= old('jam'); ?>">
                            <div class="invalid-feedback">
                                <?= \Config\Services::validation()->getError('jam'); ?>
                            </div>
                        </div>
                        <div class="mb-3 col-md-12 form-group">
                            <label for="tempat" class="form-label"><b>Tempat pelaksanaan</b></label>
                            <input type="text" class="form-control <?= (\Config\Services::validation()->hasError('tempat')) ? 'is-invalid' : ''; ?>" id="tempat" name="tempat" value="<?= old('tempat'); ?>">
                            <div class="invalid-feedback">
                                <?= \Config\Services::validation()->getError('tempat'); ?>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="/admin/adm_bem/update/<?= $a_bem['nomor']; ?>" method="POST" role="form" enctype="multipart/form-data" class="needs-validation">
                    ...
                    <input type="hidden" name="<?= csrf_token() ?>" value="<?= csrf_hash() ?>" />
                    <input type="hidden" name="kepemilikan" id="kepemilikan" value="BEM FKI UMS">
                    <input type="hidden" name="nomor" value="<?= $a_bem['nomor']; ?>">
                    <input type="hidden" name="gambar_lama" value="<?= $a_bem['gambar']; ?>">
                    <div class="modal-body">
                        <div class="mb-3">
                            <div class="mb-3">
                                <label class="mb-2"><b>Pilih Foto Aset</b></label>
                                ...
                                <div class="mt-2 col-md-10">
                                    <input type="file" class="form-control <?= (\Config\Services::validation()->hasError('gambar')) ? 'is-invalid' : ''; ?>" id="gambar" name="gambar" value="<?= (old('gambar')) ? old('gambar') : $a_bem['gambar']; ?>" onchange="preview_img()">
                                    <div class="invalid-feedback">
                                        <?= \Config\Services::validation()->getError('gambar'); ?>
                                    </div>
                                    <div id="emailHelp" class="form-text">Direkomendasikan untuk memasukkan foto.</div>
                        ...
                        <div class="row">
                            <div class="mb-3 col-md-6">
                                <label for="id_inventaris" class="form-label"><b>Nomor Inventaris</b></label>
                                <input type="text" class="form-control <?= (\Config\Services::validation()->hasError('id_inventaris')) ? 'is-invalid' : ''; ?>" id="id_inventaris" name="id_inventaris" value="<?= (old('id_inventaris')) ? old('id_inventaris') : $a_bem['id_inventaris']; ?>">
                                <div class="invalid-feedback">
                                    <?= \Config\Services::validation()->getError('id_inventaris'); ?>
                                </div>
                            </div>
                            <div class="mb-3 col-md-6">
                                <label for="nama_aset" class="form-label"><b>Nama Aset</b></label>
                                <input type="text" class="form-control <?= (\Config\Services::validation()->hasError('nama_aset')) ? 'is-invalid' : ''; ?>" id="nama_aset" name="nama_aset" value="<?= (old('nama_aset')) ? old('nama_aset') : $a_bem['nama_aset']; ?>">
                                <div class="invalid-feedback">
                                    <?= \Config\Services::validation()->getError('nama_aset'); ?>
                                </div>
                            </div>
                            <div class="mb-3 col-md-4">
                                <label for="jumlah_kapasitas" class="form-label"><b>Jumlah</b></label>
                                <input type="number" min="1" class="form-control <?= (\Config\Services::validation()->hasError('jumlah_kapasitas')) ? 'is-invalid' : ''; ?>" id="jumlah_kapasitas" name="jumlah_kapasitas" value="<?= (old('jumlah_kapasitas')) ? old('jumlah_kapasitas') : $a_bem['jumlah_kapasitas']; ?>">
                                <div class="invalid-feedback">
                                    <?= \Config\Services::validation()->getError('jumlah_kapasitas'); ?>
                                </div>
                            </div>
...
<!-- modal untuk edit daftar agenda -->
<?php foreach ($home as $h) : ?>
    <div class="modal fade" id="ubah<?php echo $h['id_agenda']; ?>" tabindex="-1" role="dialog" aria-labelledby="editLabel">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="editLabel">Edit data agenda</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <form action="/admin/adm_bem/perbaharui/<?= $h['id_agenda']; ?>" method="POST" role="form" enctype="multipart/form-data" class="needs-validation">
                    <?= csrf_field(); ?>
                    <input type="hidden" name="id_agenda" value="<?= $h['id_agenda']; ?>">
                    <div class="modal-body">
                        <div class="row">
                            <div class="mb-3 col-md-12">
                                <label for="agenda" class="form-label"><b>Nama agenda</b></label>
                                <input type="text" class="form-control <?= (\Config\Services::validation()->hasError('agenda')) ? 'is-invalid' : ''; ?>" id="agenda" name="agenda" value="<?= (old('agenda')) ? old('agenda') : $h['agenda']; ?>">
                                <div class="invalid-feedback">
                                    <?= \Config\Services::validation()->getError('agenda'); ?>
                                </div>
                            </div>
                            <div class="mb-3 col-md-12">
                                <label for="penyelenggara" class="form-label"><b>Penyelenggara agenda</b></label>
                                <input type="text" class="form-control <?= (\Config\Services::validation()->hasError('penyelenggara')) ? 'is-invalid' : ''; ?>" id="penyelenggara" name="penyelenggara" value="<?= (old('penyelenggara')) ? old('penyelenggara') : $h['penyelenggara']; ?>">
                                <div class="invalid-feedback">
                                    <?= \Config\Services::validation()->getError('penyelenggara'); ?>
                                </div>
                            </div>
                            <div class="mb-3 col-md-6">
                                <label for="waktu" class="form-label"><b>Tanggal</b></label>
                                <input type="date" id="picker_agenda" class="form-control <?= (\Config\Services::validation()->hasError('waktu')) ? 'is-invalid' : ''; ?>" id="waktu" name="waktu" value="<?= (old('waktu')) ? old('waktu') : $h['waktu']; ?>">
                                <div class="invalid-feedback">
                                    <?= \Config\Services::validation()->getError('waktu'); ?>
                                </div>
                            </div>
                            <div class="mb-3 col-md-6">
                                <label for="jam" class="form-label"><b>Pukul</b></label>
                                <input type="time" id="picker_agenda" class="form-control <?= (\Config\Services::validation()->hasError('jam')) ? 'is-invalid' : ''; ?>" id="jam" name="jam" value="<?= (old('jam')) ? old('jam') : $h['jam']; ?>">
                                <div class="invalid-feedback">
                                    <?= \Config\Services::validation()->getError('jam'); ?>
                                </div>
                            </div>
                            <div class="mb-3 col-md-12">
                                <label for="tempat" class="form-label"><b>Tempat Pelaksanaan</b></label>
                                <input type="text" class="form-control <?= (\Config\Services::validation()->hasError('tempat')) ? 'is-invalid' : ''; ?>" id="tempat" name="tempat" value="<?= (old('tempat')) ? old('tempat') : $h['tempat']; ?>">
                                <div class="invalid-feedback">
                                    <?= \Config\Services::validation()->getError('tempat'); ?>
                                </div>
                            </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="/admin/adm_bem/delete/<?= $a_bem['nomor']; ?>" method="post" role="form" enctype="multipart/form-data">
                        <?= csrf_field(); ?>
                        <input type="hidden" name="nomor" value="<?php echo $a_bem['nomor']; ?>">
                        <input type="hidden" name="gambar_lama" value="<?= $a_bem['gambar']; ?>">
                        <div class="modal-body">
                            <div class="mb-3">
                                <div class="mb-3">
                            ...
                            <div>
                                <label for="id_inventaris" class="form-label">Nomor Inventaris : <?= $a_bem['id_inventaris']; ?></label>
                            </div>
                            <div class="mb-3">
                                <label for="nama_aset" class="form-label">Nama Aset : <?= $a_bem['nama_aset']; ?></label>
                            </div>
...
<!-- modal untuk hapus daftar agenda -->
<?php foreach ($home as $h) : ?>
    <div class="modal fade" id="delete<?= $h['id_agenda']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <form action="/admin/adm_bem/hapus/<?= $h['id_agenda']; ?>" method="post" role="form" enctype="multipart/form-data">
                        <?= csrf_field(); ?>
                        <input type="hidden" name="nomor" value="<?php echo $h['id_agenda']; ?>" <div class="modal-body">
                        <div>
                            <label for="agenda" class="form-label">Nama agenda : <?= $h['agenda']; ?></label>
                        </div>
                        <div class="mb-3">
                            <label for="penyelenggara" class="form-label">Penyelenggara : <?= $h['penyelenggara']; ?></label>
                        </div>
                        <div id="emailHelp" class="form-text">Apakah anda yakin akan menghapus data agenda?</div>
                </div>
                <div class="modal-footer">
                    <!-- <button type="button" class="bi bi-close btn btn-secondary" data-bs-dismiss="modal">Batal</button> -->
                    <button type="submit" name="update" class="bi bi-trash btn btn-danger"> Hapus</button>
    ...
    <div class="modal fade" id="remove<?= $l['id_peminjam']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="/admin/adm_bem/remove/<?= $l['id_peminjam']; ?>" method="post" role="form" enctype="multipart/form-data">
                        <?= csrf_field(); ?>
...
<?php foreach ($laporan_p as $l) : ?>
    <div class="modal fade" id="detail<?= $l['id_peminjam']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <form action="/admin/adm_bem/update_a/<?= $l['id_peminjam']; ?>" role="form" method="GET" enctype="multipart/form-data">
                <div class="modal-content">
                    <div class="modal-header">
...
<!-- script untuk tombol setujui/tolak toggle class disabel -->
<script type="text/javascript">
    $(document).ready(function() {
        $("#btn_st_ts").on("click", "button", function() {
            // if ($(this).hasClass("disabled").on("click", "button")) {
...
<div class="modal fade" id="rentang_p" aria-hidden="true" aria-labelledby="exampleModalToggleLabel" tabindex="-1">
    <form method="POST" action="/admin/adm_bem/index">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                ...
                <div class="form-group">
                    <div class="modal-footer">
                        <button class="bi bi-eye btn btn-success" id="tampilkan_p" type="submit" data-bs-toggle="modal"> Tampilkan</button>
                    </div>
                </div>
            </div>
        </div>
...
<!-- script utk tanggal di print feature -->
<script>
    $('#tampilkan_p').click(function() {
    ...
    <form method="POST" action="/admin/adm_bem/index">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                ...
                <div class="form-group">
                    <div class="modal-footer">
                        <button class="bi bi-eye btn btn-success" id="tampilkan_i" type="submit" data-bs-toggle="modal"> Tampilkan</button>
                    </div>
                </div>
            </div>
        </div>
...
<!-- script for print feature -->
<script>
    $('#tampilkan_i').click(function() {
        $('#dr_i').text($('#dr_filter_i').val());
        $('#sp_i').text($('#sp_filter_i').val());
    });
</script>

<!-- modal untuk menampilkan rentang/filter agenda ormawa -->
<div class="modal fade" id="rentang_a" aria-hidden="true" aria-labelledby="exampleModalToggleLabel" tabindex="-1">
    <form method="POST" action="/admin/adm_bem/index">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalToggleLabel">Filter Laporan Agenda Ormawa</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <div class="row">
                        <div class="col">
                            ...
                            <div class="form-group">
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        <label for="dr_filter_a" class="form-label">
                                            <h6>Dari</h6>
                                        </label>
                                        <input type="datee" name="dr_filter_a" id="dr_filter_a" value="<?= old('dr_filter_a'); ?>" class="form-control <?= (\Config\Services::validation()->hasError('dr_filter_a')) ? 'is-invalid' : ''; ?>">
                                        <div class="invalid-feedback">
                                            <?= \Config\Services::validation()->getError('dr_filter_a'); ?>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <label for="sp_filter_a" class="form-label">
                                            <h6>Sampai</h6>
                                        </label>
                                        <input type="datee" name="sp_filter_a" id="sp_filter_a" value="<?= old('sp_filter_a'); ?>" class="form-control inline <?= (\Config\Services::validation()->hasError('sp_filter_a')) ? 'is-invalid' : ''; ?>">
                                        <div class="invalid-feedback">
                                            <?= \Config\Services::validation()->getError('sp_filter_a'); ?>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="form-group">
                    <div class="modal-footer">
                        <button class="bi bi-eye btn btn-success" id="tampilkan_a" type="submit" data-bs-toggle="modal"> Tampilkan</button>
                    </div>
                </div>
            </div>
        </div>
...
<!-- script for print feature -->
<script>
    $('#tampilkan_a').click(function() {
        $('#dr_a').text($('#dr_filter_a').val());
        $('#sp_a').text($('#sp_filter_a').val());
    });
</script>
...
<script>
    ...
    $('#dr_filter_a').datetimepicker({
        datepicker: true,
        format: 'Y-m-d',
    })
    $('#sp_filter_a').datetimepicker({
        datepicker: true,
        format: 'Y-m-d',
        onShow: function(ct) {
            this.setOptions({
                minDateTime: $('#dr_filter_a').val() ? $('#dr_filter_a').val() : false
            })
        }
    })
</script>
...
<!-- modal untuk menampilkan laporan agenda ormawa yang ditentukan (with print feature) -->
<div class="modal fade" id="laporan_a" aria-hidden="true" aria-labelledby="exampleModalToggleLabel2" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalToggleLabel2">Laporan Agenda Ormawa FKI</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="print-area" id="laporan_cetak_a">
                <div class="modal-body">
                    <div class="row table-responsive">
                        <div class="col">
                            <h3>Laporan Agenda Ormawa Fki</h3>
                            <hr>
                            <span>
                                <h5>Dari tanggal
                                    <span id="dr_a"></span>
                                    <?= $dari_a . " sampai " . $sampai_a ?>
                                    <span id="sp_a"></span>
                                </h5>
                            </span>
                            <br>
            ...
            <div class="modal-footer">
                <a class="bi bi-printer btn btn-success no-print" href="javascript:printDiv('laporan_cetak_a');"> Cetak</a>
                <!-- <button class="bi bi-arrow-left-square btn btn-primary" data-bs-target="#rentang" data-bs-toggle="modal"> Kembali</button> -->
            </div>
        </div>
    </div>
