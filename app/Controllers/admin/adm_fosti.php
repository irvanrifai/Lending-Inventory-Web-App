...
class adm_fosti extends BaseController
{
    protected $asetModel;
    ...
    public function index()
    {
        ...
        return view('pages/admin/adm_fosti', $data);
    }
    ...
    public function save()
    {
        ...
        if (!$this->validate([
            ...
            return redirect()->to('/pages/admin/adm_fosti')->withInput();
        }
        ...
        return redirect()->to('/pages/admin/adm_fosti');
    }
    ...
    {
        // cek ID inventaris
        // $inventaris_lama = $this->adm_fostiModel->getadm_fosti($this->request->getVar('nomor'));
        ...
        if (!$this->validate([
            ...
            return redirect()->to('/pages/admin/adm_fosti/' . $this->request->getVar('nomor'))->withInput();
        }
