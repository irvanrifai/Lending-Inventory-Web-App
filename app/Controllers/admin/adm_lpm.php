...
class adm_lpm extends BaseController
{
    protected $asetModel;
    ...
    public function index()
    {
        ...
        return view('pages/admin/adm_lpm', $data);
    }
    ...
    public function save()
    {
        ...
        if (!$this->validate([
            ...
            return redirect()->to('/pages/admin/adm_lpm')->withInput();
        }
        ...
        return redirect()->to('/pages/admin/adm_lpm');
    }
    ...
    {
        // cek ID inventaris
        // $inventaris_lama = $this->adm_lpmModel->getadm_lpm($this->request->getVar('nomor'));
        ...
        if (!$this->validate([
            ...
            return redirect()->to('/pages/admin/adm_lpm/' . $this->request->getVar('nomor'))->withInput();
        }
