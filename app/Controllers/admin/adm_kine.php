...
class adm_kine extends BaseController
{
    protected $asetModel;
    ...
    public function index()
    {
        ...
        return view('pages/admin/adm_kine', $data);
    }
    ...
    public function save()
    {
        ...
        if (!$this->validate([
            ...
            return redirect()->to('/pages/admin/adm_kine')->withInput();
        }
        ...
        return redirect()->to('/pages/admin/adm_kine');
    }
    ...
    {
        // cek ID inventaris
        // $inventaris_lama = $this->adm_kineModel->getadm_kine($this->request->getVar('nomor'));
        ...
        if (!$this->validate([
            ...
            return redirect()->to('/pages/admin/adm_kine/' . $this->request->getVar('nomor'))->withInput();
        }
