...
class adm_himatif extends BaseController
{
    protected $asetModel;
    ...
    public function index()
    {
        ...
        return view('pages/admin/adm_himatif', $data);
    }
    ...
    public function save()
    {
        ...
        if (!$this->validate([
            ...
            return redirect()->to('/pages/admin/adm_himatif')->withInput();
        }
        ...
        return redirect()->to('/pages/admin/adm_himatif');
    }
    ...
    {
        // cek ID inventaris
        // $inventaris_lama = $this->adm_himatifModel->getadm_himatif($this->request->getVar('nomor'));
        ...
        if (!$this->validate([
            ...
            return redirect()->to('/pages/admin/adm_himatif/' . $this->request->getVar('nomor'))->withInput();
        }
