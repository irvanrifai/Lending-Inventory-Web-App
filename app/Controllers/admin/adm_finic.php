...
class adm_finic extends BaseController
{
    protected $asetModel;
    ...
    public function index()
    {
        ...
        return view('pages/admin/adm_finic', $data);
    }
    ...
    public function save()
    {
        ...
        if (!$this->validate([
            ...
            return redirect()->to('/pages/admin/adm_finic')->withInput();
        }
        ...
        return redirect()->to('/pages/admin/adm_finic');
    }
    ...
    {
        // cek ID inventaris
        // $inventaris_lama = $this->adm_finicModel->getadm_finic($this->request->getVar('nomor'));
        ...
        if (!$this->validate([
            ...
            return redirect()->to('/pages/admin/adm_finic/' . $this->request->getVar('nomor'))->withInput();
        }
