...
class adm_himakom extends BaseController
{
    protected $asetModel;
    ...
    public function index()
    {
        ...
        return view('pages/admin/adm_himakom', $data);
    }
    ...
    public function save()
    {
        ...
        if (!$this->validate([
            ...
            return redirect()->to('/pages/admin/adm_himakom')->withInput();
        }
        ...
        return redirect()->to('/pages/admin/adm_himakom');
    }
    ...
    {
        // cek ID inventaris
        // $inventaris_lama = $this->adm_himakomModel->getadm_himakom($this->request->getVar('nomor'));
        ...
        if (!$this->validate([
            ...
            return redirect()->to('/pages/admin/adm_himakom/' . $this->request->getVar('nomor'))->withInput();
        }
